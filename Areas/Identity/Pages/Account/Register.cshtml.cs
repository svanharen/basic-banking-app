...
namespace ASP_NET_Assignment1.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ErrorMessage = "Alphabetical only please.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //clientAccount.ClientID = client.ClientID;
                    //clientAccount.Client = client;
                    

                    //client.ClientAccounts.Add(clientAccount);
